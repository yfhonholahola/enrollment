		...
		try {
			if (courseService.count() == 0) {
				...
				*/
				...
				//Sem1
				Courses courseADD = new Courses("ADD", "APPLICATION DESIGN AND DEVELOPMENT","1",StudentMgrUtils.deptCS,2016,8,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdB, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdC, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdD, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdE, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdF, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdG, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdH, dateFormat.parse("2016-09-01 00:00:00"))));				
				Courses courseOS = new Courses("OS","OPERATING SYSTEMS","1",StudentMgrUtils.deptCS,2016,4,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdB, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdC, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdD, dateFormat.parse("2016-09-01 00:00:00"))));
				Courses courseSISB = new Courses("SISB","Strategic Information Systems for Business","1",StudentMgrUtils.deptIS,2016,6,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdE, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdF, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdG, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdH, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdI, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdJ, dateFormat.parse("2016-09-01 00:00:00"))));
				Courses courseEAD = new Courses("EAD","Enterprise Application Development","1",StudentMgrUtils.deptBIT,2016,2,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdI, dateFormat.parse("2016-09-01 00:00:00")),new Enrolled(StudentMgrUtils.stdJ, dateFormat.parse("2016-09-01 00:00:00"))));
				
				//Sem2
				Courses coursePM = new Courses("PM","Project Management","2",StudentMgrUtils.deptBIT,2017,10,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdB, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdC, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdD, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdE, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdF, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdG, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdH, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdI, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdJ, dateFormat.parse("2016-12-22 00:00:00"))));
				Courses courseNAP = new Courses("NAP","Networks And Protocols","2",StudentMgrUtils.deptCS,2017,4,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdB, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdC, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdD, dateFormat.parse("2016-12-22 00:00:00"))));
				Courses courseISM = new Courses("ISM","Information Systems Management","2",StudentMgrUtils.deptIS,2017,4,0,Arrays.asList(new Enrolled(StudentMgrUtils.stdE, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdF, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdG, dateFormat.parse("2016-12-22 00:00:00")),new Enrolled(StudentMgrUtils.stdH, dateFormat.parse("2016-12-22 00:00:00"))));
				
				//Sem3
				Courses courseKDDM = new Courses("KDDM","Knowledge Discovery And Data Mining","3",StudentMgrUtils.deptIS,2018,10,9,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2018-05-12 15:30:00"))));
				Courses courseADS = new Courses("ADS","Advanced Database Systems","3",StudentMgrUtils.deptCS,2018,8,7,Arrays.asList(new Enrolled(StudentMgrUtils.stdA, dateFormat.parse("2018-15-22 15:32:00"))));				
