		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<p class="mb-4">Find the information of the course which is the
						most popular course enrolled by students.<span style="color:red;"><c:out value="${not empty filter ? filter : ''}" /></span>
					</p>
								...
								<div class="card-body">
									<form>
										<div class="form-group row">
											<label for="courseID" class="col-sm-4 col-form-label">Course
												ID</label>
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="courseID" value="${result.courseID}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="level" value="${result.level}">
											</div>
										</div>

										<div class="form-group row">
											<label for="deptName" class="col-sm-4 col-form-label">Department</label>
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="deptName" value="${result.department.deptName}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="location" value="${result.department.location}">
											</div>
										</div>

										<div class="form-group row">
											<label for="availablePlace" class="col-sm-4 col-form-label">Available
												Places</label>
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="availablePlace" value="${result.availablePlaces}">
											</div>
										</div>

										<div class="form-group row">
											<label for="classSize" class="col-sm-4 col-form-label">Size</label>
											<div class="col-sm-8">
												<input type="text" readonly class="form-control-plaintext"
													id="classSize" value="${result.classSize}">
											</div>
										</div>
								...
								<div class="card-body">
									<div class="table-responsive ">
										<table class="table table-bordered" id="dataTable"
											...
											<tbody>
												<c:forEach items="${result.enrolled}" var="item">
													<tr>
														<td>${item.student.stuName}</td>
														<td><fmt:formatDate value="${item.enrolDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="modal" action="/popularCourse" method="post">
						<div class="form-group">
							<label for="popluarFormControlSelect">Popularity</label> <select
								class="form-control" id="popluarFormControlSelect" name="pop">								
								<c:forEach items="${popularity}" var="item">
