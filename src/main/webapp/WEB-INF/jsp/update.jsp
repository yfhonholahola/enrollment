				...
				<div id="collapseStudentPages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/studentCount">Student Count</a> <a
							...
							Enrollment</a> <a class="collapse-item" href="/join">Join Course</a>
					</div>
				</div></li>
...
<%-- 					<c:if test="${not empty selected}"> --%>
						<div class="row">
							<!-- Detail -->
							<div class="col-lg-6">
								<form:form method="post" modelAttribute="selected">
									<div class="card position-relative">
										...
										<div class="card-body">
											<div class="form-group row">
												<form:hidden path="id" value="${selected.id}" />
												<form:hidden path="enrolled" value="${selected.enrolled}" />
												<form:hidden path="enrolledCount" value="${selected.enrolledCount}" />
											</div>
											...
											<spring:bind path="courseID">
												<div class="form-group row">
													<label for="courseID" class="col-sm-4 col-form-label">Course
														ID</label>
													<div class="col-sm-8">
														<form:input class="form-control" id="courseID" path="courseID" value="${selected.courseID}" />
													</div>
												</div>
											</spring:bind>
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<form:input type="text" class="form-control" id="title"
															name="title" path="title" value="${selected.title}" />
													</div>
												</div>
											</spring:bind>
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<form:input type="text" class="form-control" id="level"
															name="level" path="level" value="${selected.level}" />
													</div>
												</div>
											</spring:bind>
											...
											<spring:bind path="department">
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<form:select class="form-control" id="department"
															name="department" path="department">
	<%-- 														<c:forEach items="${deptList}" var="item">
																<option value="${item}">${item.deptName}</option>
															</c:forEach> --%>
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<form:input type="text" class="form-control" id="year"
															name="year" value="${selected.year}" path="year" />
													</div>
												</div>
											</spring:bind>

											<spring:bind path="availablePlaces">
												<div class="form-group row">
													<label for="availablePlaces" class="col-sm-4 col-form-label">Available
														Places</label>
													<div class="col-sm-8">
														<form:input type="text" class="form-control"
															id="availablePlaces" name="availablePlaces"
															path="availablePlaces" value="${selected.availablePlaces}" />
													</div>
												</div>
											</spring:bind>

											<spring:bind path="classSize">
												<div class="form-group row">
													<label for="classSize" class="col-sm-4 col-form-label">Size</label>
													<div class="col-sm-8">
														<form:input type="text" class="form-control" id="classSize"
															name="classSize" path="classSize"
															value="${selected.classSize}" />
													</div>
												</div>
											</spring:bind>
										</div>
