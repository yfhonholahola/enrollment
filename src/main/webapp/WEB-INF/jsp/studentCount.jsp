		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<p>List the numbers of students for each course, who have
						enrolled the course offered by the CS department in 2016. <span style="color:red;"><c:out value="${not empty filter ? filter : ''}" /></span>
					</p>

					<!-- DataTales -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Student Count
								DataTables</h6>
						</div>
						<div class="card-body">
		...
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="modal" action="/studentCount" method="post">
