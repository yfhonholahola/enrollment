		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<p class="mb-4">Insertion operation</p>
								...
								<div class="card position-relative">
									...
									<div class="card-body">
										<div class="form-group row">
											...
											<form:hidden path="enrolled" value="${result.enrolled}" />
											<form:hidden path="enrolledCount" value="${student.enrolledCount}" />
										</div>
										...
										<spring:bind path="courseID">
											<div class="form-group row">
												<label for="courseID" class="col-sm-4 col-form-label">Course
													ID</label>
												<div class="col-sm-8">
													<form:input class="form-control" id="courseID" path="courseID" value="${result.courseID}" />
												</div>
											</div>
										</spring:bind>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<form:input type="text" class="form-control" id="title"
														name="title" path="title" value="${result.title}" />
												</div>
											</div>
										</spring:bind>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<form:input type="text" class="form-control" id="level"
														name="level" path="level" value="${result.level}" />
												</div>
											</div>
										</spring:bind>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<form:input type="text" class="form-control" id="year"
														name="year" value="${result.year}" path="year" />
												</div>
											</div>
										</spring:bind>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<form:input type="text" class="form-control"
														...
														path="availablePlaces" value="${result.availablePlaces}" />
												</div>
											</div>
										</spring:bind>
